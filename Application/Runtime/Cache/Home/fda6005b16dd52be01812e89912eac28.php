...
<link href="<?php echo (SITE); ?>/Public/style/index.v3.0.css?10" rel="stylesheet" type="text/css">
...
//		doRecord(idstr);
	...
	$(function () {
		...
		$(".piao_btn").click(function(){
			var url = siteurl+"/do.php?inajax=1&ado=conference2&ac=praise_author&parameter="+$("#categoryid").val()+"&jsoncallback=?";
			$.getJSON(url, {conferenceid:conference_id},function(json){
				var retval = json.data;
				if(retval=='1'){
					var praise_num = parseInt($(".piao_btn p").html())+1;
					$(".piao_btn p").html(praise_num);
					$(".tanchuang").show();
				}
				if(retval=='0'){
					alert('您已支持了作者，感谢参与');
...
<div class="main_left">
    ...
    <div class="clear"></div>
    <div class="main_zw"><?php echo (nl2br($info["viewtext"])); ?></div>
    <div class="share">
	<!-- Baidu Button BEGIN -->
	...
	<div class="pl">
	   	<div class="pl_nr" id="comment_bottom">
			<form onsubmit="return false;" id="conference_login_reply_<?php echo ($info["id"]); ?>">
...
<div class="Blank"></div>
	...
	<div class="toupiaokuang">
		<div class="tanchuang" style="display:none;">
			<a href="javascript:void(0);" class="close"></a>
			<p>用一句话赞美一下他吧</p>
			<div class="ping" id="comment_praise">
				<input name="content" type="text" /><a href="###" onclick="return conference_submit('comment_praise', '-7_<?php echo ($info["id"]); ?>_2');"></a>
				<div class="clear"></div>
			</div>
		</div>
		<div class="toupiao_left">
			<p class="piao_text">若支持主持人请您投下一票</p>
			<div class="piao_btn">
			<p><?php echo ($other["praise"]); ?></p>
			</div>
		</div>
		<div class="toupiao_right">
			<a href="#"><img src="<?php echo (SITE); ?>/Public/images/conference/n/huodong.jpg"></a>
		</div>
	</div>
    <div class="Blank"></div>
