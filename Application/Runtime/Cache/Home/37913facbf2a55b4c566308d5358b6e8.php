...
<div id="main">
  <div class="block">
    <h1><span class="fright"><img src="<?php echo (SITE); ?>/Public/images/pk/pk_h1bg_r.jpg"></span><span class="fright"><a href="<?php echo (IISSSITE); ?>/pkt/plist" target="_blank">更多&gt;&gt;</a></span><a class="wqht"></a></h1>
  </div>
  <div class="main_left">
