...
<dl><dt class="r"><a href="<?php echo ($iisssite); ?>/pk/app/<?php echo ($pkinfo["id"]); ?>/1" class="blue morelist">查看正方全部评论>></a><img src="<?php echo ($site); ?>/Public/images/pk/best_y.jpg" /><Br /><em><?php echo (date("Y-m-d H:i:s",$vo["postdate"])); ?></em><a target="_blank" href="#"><?php echo ($vo["username"]); ?></a></dt>
...
<div id="rev_m"><a href="<?php echo ($iisssite); ?>/pk/app/<?php echo ($pkinfo["id"]); ?>/1" class="blueonline">查看正方全部评论>></a></div></div>
<div id="review_right">

<?php if(is_array($badcomm)): foreach($badcomm as $key=>$vo): ?><div class="reviews" id="cmmtop_<?php echo ($vo["id"]); ?>">
<dl><dt class="n"><a href="<?php echo ($iisssite); ?>/pk/opp/<?php echo ($pkinfo["id"]); ?>/1" class="blue morelist">查看反方全部评论>></a><img src="<?php echo ($site); ?>/Public/images/pk/best_n.jpg" /><Br /><em><?php echo (date("Y-m-d H:i:s",$vo["postdate"])); ?></em><a class="blue" target="_blank" href="#"><?php echo ($vo["username"]); ?></a></dt>
             <dd>标题：<?php echo ($vo["subject"]); ?></dd>
           <?php if($vo["quotecomm"] != ''): ?><dd>
	           <div class="bg">引用：<?php echo ($vo["quotecomm"]["username"]); ?></a><br />
					<span>
