...
<link href="<?php echo (SITE); ?>/Public/style/chamber.v1.1.css?06074" rel="stylesheet" type="text/css" />
<link href="<?php echo (SITE); ?>/Public/style/thickbox.css" rel="stylesheet" media="screen">
...
<div class="banner">
	...
	<h1><?php echo ($info["subject"]); ?></h1><p>
	<?php echo ($info["shortsubject"]); ?></p>
	</div>
...
<div class="main_l">
	<div class="text_main">
		<h1><a href="#"></a></h1>
		<p><img src="<?php echo (ATTPATH); ?>/<?php echo ($info["viewimg"]); ?>" /><?php echo (nl2br($info["viewtext"])); ?>
		</p>
	</div>
		...
		<div class="comment_main">
		   <form onsubmit="return false;">
			   ...
			   <div class="comment_sub">
					<input type="checkbox" value="1" name="anonymous" class="niming"><label>&nbsp;&nbsp;匿名</label>
					<input type="image" onclick="conference_submit('comment_top', '-7_<?php echo ($info["id"]); ?>_1');" src="<?php echo (SITE); ?>/Public/images/conference/shout_tj.jpg" class="tj_button">
			   </div>
			   <div class="clear"></div>
		   </form>
		</div>
...
<div class="main_r">
	<div class="block">
		<h1><a class="cursor">相关资料</a></h1>

			<div class="data_m">
				<?php if(is_array($related)): foreach($related as $key=>$vo): if($key == 0): ?><p><img src="<?php echo (ATTPATH); ?>/<?php echo ($vo["pic"]); ?>" /><span><a href="<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["subject"]); ?></a></span><br /><?php echo (mb_substr($vo["summary"],0,43,'utf8')); ?></p><?php endif; endforeach; endif; ?>
				<br class="clear" />
				<ul>
					<?php if(is_array($related)): foreach($related as $key=>$vo): if($key > 0): ?><li><a href="<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["subject"]); ?>" target="_blank"><?php echo ($vo["subject"]); ?></a></li><?php endif; endforeach; endif; ?>
				</ul>
			</div>
	</div>
	<div class="Blank"></div>
	<div class="block">
		<h1><a class="cursor">调查投票</a></h1>
		<div class="vote_main">
	...
	<div class="Blank"></div>
	<div class="block">
		<h1><span class="fright"><!--a href="#">更多&gt;&gt;</a--></span><a class="cursor">本期主持</a></h1>

			<div class="chair">
				<p><span><img src="<?php echo ($other["avatarpic"]); ?>" /><br /><a href="<?php echo ($other["blogurl"]); ?>/<?php echo ($other["authordomain"]); ?>" target="_blank"><?php echo ($other["author"]); ?></a></span><?php echo (nl2br(mb_substr($other["authorsummary"],0,108,'utf8'))); ?></p>
			</div>
	</div>
...
<div id="main">
	<div class="message_bk">
		<h1><span class="fright"></span><a></a></h1>
		<div class="message_m">
			<div class="theme">
				<div class="pagebox fright"  id="mutipagetop"></div>
				<p><span>主题:</span><a name="acommentlist"><?php echo ($info["subject"]); ?></a><a class="grayfont">(共有<?php echo ($other["count"]); ?>位网友参与，<?php echo ($other["commcount"]); ?>条精华评论)</a></p>
			</div>
			<div id="gv_conference_list_-7_<?php echo ($info["id"]); ?>_<?php echo ($other["authorid"]); ?>"></div>
...
<div id="main">
	<div class="comment_bk" id='comment_foot'>
		...
		<div class="comment_main">
               ...
               <p>网友评论仅供其表达个人看法，并不表明战略网同意其观点或证实其描述。</p>
			   <div class="comment_sub">
			   		<input class="niming" name="anonymous" value="1" type="checkbox"><label>&nbsp;&nbsp;匿名</label>
